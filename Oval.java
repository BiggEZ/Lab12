...
public class Oval extends Shape
{
    ...
    public Oval(Point pointCenter, int diameter1, int diameter2, Color color, boolean filled)
    {
        ...
        location[1] = new Point(pointCenter.x - diameter1/2, pointCenter.y + diameter2/2);
        location[2] = new Point(pointCenter.x + diameter1/2, pointCenter.y + diameter2/2);
        location[3] = new Point(pointCenter.x - diameter1/2, pointCenter.y - diameter2/2);
        location[4] = new Point(pointCenter.x + diameter1/2, pointCenter.y - diameter2/2); 
